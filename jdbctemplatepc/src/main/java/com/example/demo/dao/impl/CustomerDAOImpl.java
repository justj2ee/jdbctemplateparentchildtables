...
public class CustomerDAOImpl implements CustomerDAO {
	...
	private static final String UPDATE="UPDATE CUSTOMER SET ID=:ID, FNAME=:FNAME, LNAME=:LNAME, ADDRESS=:ADDRESS, CITY=:CITY, STATE = :STATE, ZIP_CD=:ZIP_CD, PHONE_NO=:PHONE_NO WHERE ID=:ID";
	private static final String GET="SELECT ID, FNAME, LNAME, ADDRESS, CITY, STATE, ZIP_CD, PHONE_NO FROM CUSTOMER WHERE ID=:ID";
	...
	public Optional<Customer> get(int id) {
		...
		try {
			customer = namedParameterJdbcTemplate.queryForObject(GET, namedParameters, new BeanPropertyRowMapper<Customer>(Customer.class));
